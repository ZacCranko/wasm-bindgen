...
export interface InitOutput {
    ...
    readonly wasm_bindgen__convert__closures_____invoke__h0000000000000001: (a: number, b: number, c: any, d: number, e: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h0000000000000002: (a: number, b: number, c: any, d: any) => void;
    readonly wasm_bindgen__convert__closures_____invoke__h0000000000000004: (a: number, b: number, c: any) => [number, number];
    readonly wasm_bindgen__convert__closures_____invoke__h0000000000000003: (a: number, b: number) => number;
    readonly wasm_bindgen__convert__closures_____invoke__h0000000000000000: (a: number, b: number) => void;
